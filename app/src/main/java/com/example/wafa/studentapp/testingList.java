...
public class testingList extends AppCompatActivity {
...
//Android Layout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Student
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDialog=new ProgressDialog(testingList.this);
                            ...
                            mUserDatabase.child("image").setValue(download_url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(testingList.this, "Uploading  Successful", Toast.LENGTH_LONG).show();

                                    }
                                }
                            });
                        } else {
                            Toast.makeText(testingList.this, "Error", Toast.LENGTH_LONG).show();
                            mProgressDialog.dismiss();
                        }
    ...
    public void showData(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            final String courseName = info.setCoursename(dataSnapshot.child("coursename").getValue().toString());
            final String phone = info.setPhone(dataSnapshot.child("phone").getValue().toString());
            final String image = dataSnapshot.child("image").getValue().toString();

            Picasso.with(testingList.this).load(image).placeholder(R.drawable.default_img).into(mDisplayImage);
